import"./modulepreload-polyfill-Dezn_h7o.js";/* empty css              */import{n as e}from"./firebase-db-C4uRyyQf.js";async function t(){if(!localStorage.getItem(`caelys_admin_token`)){window.location.href=`/login.html`;return}try{let t=[{name:`registrations_mun`,title:`Delegate Registrations - Model United Nations`},{name:`registrations_debate`,title:`Delegate Registrations - Debate & Rhetoric`},{name:`registrations_climate`,title:`Delegate Registrations - Climate Conclave`},{name:`team_design`,title:`Team Applications - Design & Media`},{name:`team_operations`,title:`Team Applications - Operations`},{name:`team_outreach`,title:`Team Applications - Outreach`}],n=[],r=``;for(let i of t){let t=await e(i.name);if(n.push(...t),t.length>0){let e=i.name.startsWith(`team_`),n=t.map(t=>`
                  <tr>
